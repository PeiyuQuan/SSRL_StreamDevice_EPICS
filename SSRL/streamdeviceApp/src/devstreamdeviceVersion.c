...
#include "streamdeviceVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = streamdeviceVERSION;
...
static lsidset devstreamdeviceVersion = {
    5, NULL, NULL, NULL, NULL, read_string
};
epicsExportAddress(dset,devstreamdeviceVersion);
